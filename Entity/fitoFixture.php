...
class fitoFixture
{
     ...
     * @var double
     *
     * @ORM\Column(name="fotpotok", type="float")
     */
    private $fotpotok;
     ...
     * @var string
     *
     * @ORM\Column(name="proportsiyyspectra", type="string")
     */
    private $proportsiyyspectra;
     ...
     * @var 
     *
     * @ORM\Column(name="zashitaOtPerenapryajeniya", type="string")
     */
    private $zashitaOtPerenapryajeniya;
    /**
     * @var string
     *
    ...
    public function getfotpotok() {
        return $this->fotpotok;
    }
    ...
    public function setfotpotok($fotpotok) {
        $this->fotpotok = $fotpotok;
    }
    ...
    public function getproportsiyyspectra() {
        return $this->proportsiyyspectra;
    }
    ...
    public function getZashitaOtPerenapryajeniya() {
        return $this->zashitaOtPerenapryajeniya;
    }
   ...
   public function getSoprotivlenieIzolatsii() {
    ...
    public function setproportsiyyspectra( $proportsiyyspectra) {
        $this->proportsiyyspectra = $proportsiyyspectra;
    }
    ...
    public function setZashitaOtPerenapryajeniya( $zashitaOtPerenapryajeniya) {
        $this->zashitaOtPerenapryajeniya = $zashitaOtPerenapryajeniya;
    }
