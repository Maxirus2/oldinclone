...
class streetFixture
{
    ...
    /**
     * @ORM\Column(name="vnutrdiametrconsoli", type="string")
     */
    private $vnutrdiametrconsoli;
    ...
    public function getVnutrdiametrconsoli() {
        return $this->vnutrdiametrconsoli;
    }

    public function setVnutrdiametrconsoli($vnutrdiametrconsoli) {
        $this->vnutrdiametrconsoli = $vnutrdiametrconsoli;
    }
